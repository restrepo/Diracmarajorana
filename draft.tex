...
\begin{figure}
    ...
    \caption{Collider and cosmological constraints for the $\operatorname{U}(1)_{B-L}$ model, and contours of constant $g'$ in the plane of $q_s v_S$ as a function of $M_{Z'}$ with $q_S=2$.}
    \label{fig:u1blc}
\end{figure}
