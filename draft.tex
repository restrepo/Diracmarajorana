...
of two parameters~\cite{Appelquist:2002mw,Campos:2017dgc,Allanach:2018vjg}, that we choose as
\begin{align}
  X(r,l)=r R - l Y\,,
\end{align}
...
In other words, bearing in mind that $M_{Z'}/g'=3v_S/2$ we have that the energy scale of the $\operatorname{U}(1)_{X}$ symmetry breaking must be at least $\sim26$ TeV.      
On the other hand, it is remarkable the fact the next generation of CMB experiments~\cite{Benson:2014qhw,Abitbol:2019nhf} has the potential to entirely probe all the not-so minimal models~\cite{Abazajian:2019oqj}. The same constraint would apply to all gauged and anomaly free  $\operatorname{U}(1)_X$ extensions of the SM with Dirac neutrino masses, where light right handed neutrinos are associated  to the solution $(-4,-4,+5)$~\cite{Ma:2014qra,Ma:2015mjd,Ma:2015raa,Bonilla:2018ynb,Calle:2018ovc,Bonilla:2019hfb}.
