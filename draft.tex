...
The recasting of the latest ATLAS results for the search of dilepton resonances using $139\ \text{fb}^{-1}$~\cite{1903.06248} was done
in~\cite{1903.06248} for the $\operatorname{U}(1)_{B-L}$ model.
The green region in Fig.~\ref{fig:u1blc} shows the excluded region at $95\%\ \text{C.L.}$. To ease the comparison with other results, we show the exclusion as function of $M_{Z'}/g_{BL}$. In particular, the limit from LEP for $\operatorname{U}(1)_{B-L}$ model is~\cite{1408.6845}, 
\begin{align}
