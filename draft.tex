...
On the other hand, when the $Z'$ portal \cite{Langacker:2008yv,Dudas:2009uq} is the main gate to visible sector, $\psi_1$ largely annihilates into neutrinos in such a way the observed DM abundance can be reproduced without entering in conflict with the DM searches, which follows from the fact that the $Z'$ does not couples to quarks neither to charged leptons)
(see~\cite{Dudas:2009uq,Arcadi:2013qia,Alves:2013tqa,Alves:2015pea,Alves:2016cqf,Blanco:2019hah} for related phenomenological studies on $Z'$-mediated Majorana DM). 
% check Ibarra papers
...
In the $\operatorname{U}(1)_{B-L}$, cosmlogical constraints are better that current ATLAS limit for $M_{Z'}\gtrsim 4.8\ \text{TeV}$
