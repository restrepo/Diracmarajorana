...
eszWith the aim to illustrate the one-loop Dirac neutrino mass generation
...
In this case we can use the solutions to the anomaly cancellation conditions found for an Abelian gauge symmetry $\operatorname{U(1)_X}$ in~\cite{Campos:2017dgc}.
...
Abelian gauge groups $X=B-L,A,B,D,G$ defined in~\cite{Campos:2017dgc}.
