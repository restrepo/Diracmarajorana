...
%some results here
  This model is restricted by  neutrino physics,  lepton flavor violation and cosmological constrains, including  
...
The Diracness of the massive neutrinos is protected by only one extra $\operatorname{U}(1)_X$ gauge symmetry, which in turn ensures the stability of the lightest particle mediating the one-loop neutrino mass diagram. In this way the model offers in a non trivial way a the solution to both neutrino and DM puzzles.
We have showed that beyond the minimal model The new states required  may also lead to other phenomenological signals
at future hadron collider as well as lepton flavour violation experiments
We have illustrated our proposal by considering a specific
model, where simple numerical estimates allow us to show the effectiveness of the scheme regarding neutrino masses, DM and lepton flavor violating processes. Furthermore,. 
