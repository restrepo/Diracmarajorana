...
The scenario where $\psi_{R1}$ is self annihilating through $h_{i\alpha}$ interaction resembles the very well known scotogenic model \cite{Ma:2006km} whereas for dominant gauge interactions we have the  Majorana Dark matter with a $Z'$ portal. 

%$Z'$ portal~\footnote{For a recent review of Majorana Dark matter with a $Z'$ portal see~\cite{Blanco:2019hah} }
% check Ibarra papers
